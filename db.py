...
class Database:
    ...
    """
    def create_card(self,card_name,card_tag=None,card_priority=None,card_storypoint=None,card_description=None,card_status=None,card_type=None,list_id=None, user_id=None,sprint_id=None,card_start=None,card_stop=None,card_elapsed=None):
        try:
            self.cursor.execute("insert into card (card_name,card_tag,card_priority,card_storypoint,card_description,card_status,card_type,list_id, user_id,sprint_id,card_start,card_stop,card_elapsed) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)",(card_name,card_tag,card_priority,card_storypoint,card_description,card_status,card_type,list_id, user_id,sprint_id,card_start,card_stop,card_elapsed))
        except Exception as e:
            return e
    ...
    Fetches all users
    Returns:
        A list of tuples where each tuple contains full info of users
    """
    def all_users(self) :
        try :
            self.cursor.execute(
